    ...
    <div class="row" xmlns="http://www.w3.org/1999/html">
        <div class="col-4">
            <form id="photo" enctype="multipart/form-data" method="post" action="/profile/edit">
                <label for="avatar" data-bs-toggle="tooltip" data-bs-placement="right"
                       title="Нажмите на картинку для смены аватара">
            ...
            <form id="form">
                ...
                <div class="row">
                    <div class="col-12 mb-2"
                         id="about"><?= $about ?? 'Пользователь пока не оставил о себе информацию.' ?></div>
                    <?php if (UserController::isOwner($id) || UserController::isAdmin()) { ?>
