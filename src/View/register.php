...
<form class="form-signin" method="post" action="/register">
    ...
    <div class="form-label-group">
        <input type="name" id="inputName" class="form-control" placeholder="Имя" name="name"
    ...
    <div class="form-label-group">
        <input type="password" id="inputPasswordConfirm" class="form-control" placeholder="Повторите пароль"
    ...
    <div class="checkbox mb-3">
        <label>
            <input type="checkbox" name="agreement" <?= $data['agreement'] ?? '' ?>> Согласен с <a
                    class="stretched-link font-weight-bold" href="/rules">правилами</a> сайта.
        </label>
    </div>
